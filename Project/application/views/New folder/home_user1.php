...
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	<li class="topfirst"><a href="#" class="link" style="height:32px;line-height:32px;"><img src="<?php echo base_url()?>img/menu/1.png" alt=""/>ข้อมูลนักเรียน</a></li>
...
<!-- จบ ส่วนของ header -->
    <div id="contentBody">
    	<div id="menu"> </div>
          ...
          <tbody>
            <tr>
              <td colspan="2" align="center">ยินดีตอนรับฝ่ายทะเบียน</td>
            </tr>
            <tr>
              <td width="92" align="center">ชื่อ-นามสกุล</td>
              <td width="203"><?php echo $loginData['teacherName'];	?> <?php echo $loginData['teacherLname'];	?></td>
            </tr>
                        <tr>
              <td width="92" align="center">username</td>
              <td width="203"><?php echo $loginData['teacherUser'];	?> </td>
            </tr>
                        <tr>
              <td width="92" align="center">ที่อยู่</td>
              <td width="203"><?php echo $loginData['teacherAddress'];	?> </td>
            </tr>
                       <tr>
              <td width="92" align="center">E-mail</td>
              <td width="203"><?php echo $loginData['teacherEmail'];	?> </td>
            </tr>
                      <tr>
              <td width="92" align="center">โทรศัพท์</td>
              <td width="203"><?php echo $loginData['teacherPhone'];	?> </td>
            </tr>
            <tr>
              <td align="center">status</td>
              <td><?php echo $loginData['teacherStatus'];	?></td>
            </tr>
            <tr>
